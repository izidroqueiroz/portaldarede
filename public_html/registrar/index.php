...
<tr>
<td></td>
<td><br /><span style="font-size:18px;">Coisas que você deve saber:</span>
<ul style="margin:0;">
	<li><b>Este Portal é seu.</b> Este projeto é construído por todos. É software livre, gratuito e está <u>a serviço da #rede</u>.</li>
	<li><b>Democrático.</b> Tudo é definido através de mecanismos <u>genuinamente democráticos</u> (votações, eleições, etc).</li>
	<li>Há quatro formas de participação:
	<ol style="margin:0;">
		<li><b>Chat</b>: para conhecer outras pessoas.</li>
		<li><b>Debate</b>: para debater em profundidade.</li>
		<li><b>Votações</b>: para tomar decisiões.</li>
		<li><b>Grupos de Trabalho</b>: para atuar e transformar as decisões em realidade.</li>
	</ol>
	</li>
</ul>
</td>
...
<tr>
<td></td>
<td><input type="checkbox" name="condiciones" value="ok" id="checkcondiciones" required /> <label for="checkcondiciones"><b>'._('Aceptas las').' <a href="http://www'.'.'.DOMAIN.'/TOS" target="_blank">'.'Condições de uso do Portal da #rede'.' (TOS)</a>.</b></label></td>
</tr>
