...
function presentacion($titulo, $html, $url='http://www.virtualpol.vacau.com') {
	global $link;
	echo '
<!doctype html>
<html lang="es">
...
function pad($control, $ID=false, $txt='') {
	...
	switch ($control) {
		case 'print':
			global $pol;
			return '<iframe src="http://www.virtualpol.vacau.com:9001/p/'.$ID.'?userName='.$pol['nick'].'" width="100%" height="500" frameborder="0" style="background:#FFF;margin:0 -20px -9px -20px;"></iframe>';
			break;
